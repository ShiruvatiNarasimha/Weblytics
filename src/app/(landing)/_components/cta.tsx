  ...
  return (
    <Wrapper className="py-20 lg:py-32">
      <div className="z-0 relative flex flex-col items-center gap-4 py-20 lg:py-32 overflow-hidden text-center">
        ...
        >
          <div className="-top-1/2 absolute inset-x-0 bg-black/20 blur-[4rem] lg:blur-[10rem] mx-auto rounded-full size-1/2"></div>
        </AnimationContainer>
        ...
        <div className="z-30 flex flex-col justify-center items-center w-full">
          ...
          <AnimationContainer animation="fadeUp" delay={1}>
            <Link href="/projects">
              <Button
                size="lg"
                className="bg-black hover:bg-black/80 mt-6"
              >
                Get Started
